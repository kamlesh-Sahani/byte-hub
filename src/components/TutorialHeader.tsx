const TutorialHeader = ({contentType,setContentType}:{
    ...
    return (
        <div className="flex gap-5 justify-center items-center mr-auto mt-5 ">
            ...
            <button className={`px-5 py-1 outline-none border-none ] shadow-md font-semibold rounded cursor-pointer ${contentType === "question-paper" ? "bg-[#1038bbe8] text-white" : "bg-[#f3f2f2] text-black"}`} onClick={() => setContentType("question-paper")}>Question Paper</button>
        </div>
    )
}
